// POST /api/admin/opportunities/:id/approve — ported from
// backend/src/routes/admin.ts (adminRouter.post(".../approve")).
import type { VercelRequest, VercelResponse } from "@vercel/node";
import { approveOpportunity } from "../../../../backend/src/db/data-access.js";
